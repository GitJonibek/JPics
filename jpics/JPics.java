package com.example.jonib.jpics.jpics;
...
public class JPics {
    ...
    public AsyncTask<String, Void, String> downloadPDFile(){
        return new DownloadManager.DownloadFileAsyncTask().execute(this.url);
    }
